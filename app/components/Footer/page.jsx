    ...
    <>
      <footer className='pt-10 bg-blue-950'>
        <div className='max-w-screen-xl flex flex-col mx-auto px-4 text-gray-600 md:px-8'>
          <div className='justify-between sm:flex'>
            <div className='space-y-6'>
              <div className='flex flex-row justify-start dm:justify-center items-center'>
                ...
                />
                <span className='font-bold text-3xl tracking-tighter text-teal-400'>
                  Shrivel
                </span>
              </div>
            </div>
          ...
          <div className='mt-10 py-10 border-t md:text-center text-neutral-300'>
            <span>© {date.getFullYear()} Shrivel. All right reserved</span>
          </div>
        </div>
      </footer>
    </>
